# Backend Development — Prompt Sequence (Overview)

> **Public / redacted illustration.** This describes *what* the STRATA prompt sequence for a backend
...
> Tuned for backend work — services, APIs, data, and contracts. The frontend and Nuxt sequences follow
> the same shape with stack-appropriate verification and governance. The exact prompts are member-only.
